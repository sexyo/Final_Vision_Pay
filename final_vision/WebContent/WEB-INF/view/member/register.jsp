    ...
    $('#btn_join').on('click', function(){
        $.ajax({
            ...
            data: {
                ...
                "phon1" : document.getElementById("phon1").value,
                "phon2" : document.getElementById("phon2").value,
                "phon3" : document.getElementById("phon3").value,
				"mem_pw" : document.getElementById("mem_pw").value,
				"mem_addr1" : document.getElementById("mem_addr1").value,
				"mem_addr2" : document.getElementById("mem_addr2").value,
				"mem_birth" : document.getElementById("mem_birth").value,
				"mem_email" : document.getElementById("mem_email").value,
				"chk_info" : $("input[name=chk_info]:checked").val()
            },
            success: function(data){
                if(data == 0){
                   alert("회원가입실패");
		...
		<div class="col s12 z-depth-4 card-panel">
				...
				<div class="row margin">
					<div class="input-field col s8">
						...
						<label for="mem_id"	data-error="경고" class="center-align" data-success="성공">&nbsp;&nbsp;&nbsp;아이디</label>
					</div>
				...
				<div class="row margin">
					<div class="input-field col s12">
						<i class="material-icons prefix">face</i> <input id="mem_name"
							name="mem_name" type="text" /> <label for="mem_name" data-error="경고"
				...
				<div class="row margin">
					...
					<div class="input-field col s6">
 					...
 					<div class="input-field col s12"> 
						<input type="text" id="mem_addr1" name="mem_addr1" placeholder="&nbsp;&nbsp;&nbsp;주소"><br>
						<label for="mem_addr1" data-error="경고" class="center-align" data-success="성공"></label>
					</div>
 					<div class="input-field col s12"> 
						<input type="text" id="mem_addr2" name="mem_addr2">
						<label for="mem_addr2" data-error="경고" class="center-align" data-success="성공">&nbsp;&nbsp;&nbsp;상세주소</label>
					</div>
				...
				<div class="row margin">
					<div class="input-field col s12">
						<i class="mdi-social-person-outline prefix"></i> <i
							class="material-icons prefix">email</i> <input id="mem_email"
							name="mem_email" type="text" style="cursor: auto;" /> <label
							for="mem_email" data-error="경고" class="center-align"
				...
				<div class="row margin">
					<div class="input-field col s12">
						<div class="input-group date">
							...
							<input id="mem_birth" name="mem_birth" type="text" class="form-control"/> 
							<label for="mem_birth" data-error="경고" class="center-align" data-success="성공">생년월일</label> 
				...
				<div class="row margin">
					<div class="input-field col s12">
						<i class="material-icons prefix">vpn_key</i> <input id="mem_pw"
							name="mem_pw" type="password" /> <label for="mem_pw">&nbsp;&nbsp;&nbsp;비밀번호</label>
					</div>
				</div>
				...
				<div class="row">
					<div class="input-field col s12">
						<button id="btn_join" name="btn_join" type="submit" class="btn btn-success" onClick="join()">회원
							가입</button>
					</div>
					<div class="input-field col s12">
