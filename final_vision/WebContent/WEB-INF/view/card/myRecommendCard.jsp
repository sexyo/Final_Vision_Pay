...
<%
	List<Map<String,Object>> recommendList = (List<Map<String,Object>>) request.getAttribute("recommendList");
	int r_size = 0;
	r_size = recommendList.size();
 	List<String> bins = new ArrayList<String>();
		...
		if(r_size == 0){
			...
			bin1 = String.valueOf(recommendList.get(0).get("rec_card"));
		}			
		else if(r_size==2){
			bin1 = String.valueOf(recommendList.get(0).get("rec_card"));
			bin2 = String.valueOf(recommendList.get(1).get("rec_card"));
		}			
		else if(r_size==3){
			bin1 = String.valueOf(recommendList.get(0).get("rec_card"));
			bin2 = String.valueOf(recommendList.get(1).get("rec_card"));
			bin3 = String.valueOf(recommendList.get(2).get("rec_card"));
		}
...
var bin3 = "<%=bin3%>"
	if(size==0){                                                     
		 ...
		 document.getElementById(bin2).style.display = "block";   
		 document.getElementById(bin3).style.display = "block";   
		}
	else if(size==1){
		document.getElementById(bin1).style.display = "block";
		}
         ...
         <div class="navbar-header">
            <h4>
               <a class="navbar-brand" style="color: #ffffff; height: 25px"
                  href="../member/index"><</a> <a class="navbar-brand" href="../recommend/myRecommendCard">
...
<div class="container" id="rc_container">
		...
		<div>
		<span style="font-weight: bold; font-size: 40px; ">나의 소비 패턴에 기반한 추천 카드</span>
		</div>
		<div class="col-12" style="text-align: right">
		<button type="button" onclick="location.href='../recommend/recommendCard'" >모든 VISION 카드 보러 가기</button>
		</div>
			<div class="col-12">
					<div class="media" id="487123" style="display:none;">
					...
					<div class="media" id="487159" style="display:none;">
					...
					<div class="media" id="587456" style="display:none;">
					...
					<div class="media" id="587753" style="display:none;">
					...
					<div class="media" id="987183" style="display:none;">
					...
					<div class="media" id="987789" style="display:none;">
